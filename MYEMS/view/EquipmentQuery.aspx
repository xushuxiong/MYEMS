<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentQuery.aspx.cs" Inherits="MYEMS.view.EquipmentQuery" %>
                       ...
                       <tr>
                            ...
                            <td> 
                                 <select name="query_thing" id="emp_manager">
                                    ...
                                    <option value="4">设备位置</option>
                                    <option value="5">设备负责人</option>
                                    <option value="6">设备型号</option>
                                    <option value="7">设备负责部门</option>
                                </select>
                            </td>
                        </tr>
                        <tr>

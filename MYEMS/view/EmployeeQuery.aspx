<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeQuery.aspx.cs" Inherits="MYEMS.view.EmployeeQuery" %>
                       ...
                       <tr>
                            ...
                            <td> 
                                 <select name="query_thing" id="emp_manager">
                                    ...
                                    <option value="3">所在部门</option>
                                    <option value="4">电话号码</option>
                                    <option value="5">是否为管理员</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
